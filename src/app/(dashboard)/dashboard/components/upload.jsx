...
export default function UploadFile({
    ...
    return (
        <>
            <label className={`flex flex-col cursor-pointer  items-center rounded-lg shadow-md w-full py-4 h-56 md:w-4/6 lg:w-3/5 bg-[#F5F5F7] justify-center p-4 relative ${styles} ${className}`}>
